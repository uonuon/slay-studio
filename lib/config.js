...
export const DEFAULT_SETTINGS = {
  ...
  clipins: {
    enabled: true,
    types: [
      { id: "cl-big", name: "One big braid", nameAr: "ضفيرة واحدة كبيرة", price: 0, img: "" },
      { id: "cl-twin", name: "Two identical braids", nameAr: "ضفيرتين متطابقتين", price: 0, img: "" },
      { id: "cl-mix", name: "One big + one small", nameAr: "ضفيرة كبيرة + صغيرة", price: 0, img: "" },
      { id: "cl-rumi", name: "Rumi braid", nameAr: "ضفيرة رومي", price: 0, img: "" },
    ],
    colors: [
      { id: "cc-black", name: "Black", nameAr: "أسود", hex: "#181512", img: "", price: 0 },
      { id: "cc-dbrown", name: "Dark brown", nameAr: "بني غامق", hex: "#3B2A20", img: "", price: 0 },
      { id: "cc-brown", name: "Brown", nameAr: "بني", hex: "#5C4033", img: "", price: 0 },
      { id: "cc-caramel", name: "Caramel", nameAr: "كراميل", hex: "#8B6A4F", img: "", price: 0 },
      { id: "cc-blonde", name: "Blonde", nameAr: "أشقر", hex: "#C9A36A", img: "", price: 0 },
      { id: "cc-burg", name: "Burgundy", nameAr: "عنابي", hex: "#4A1F24", img: "", price: 0 },
    ],
    extras: [
